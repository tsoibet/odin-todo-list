...
function addSamples(todoList, projectList) {
    ...
    let sampleTodo1 = new _classTodo_js__WEBPACK_IMPORTED_MODULE_0__["default"]("(Sample) Workout", "abs & upper arms", (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(today, "yyyy-MM-dd"), false, false, projectList.allProjects[0]);
    let sampleTodo2 = new _classTodo_js__WEBPACK_IMPORTED_MODULE_0__["default"]("(Sample) Finish Project: Todo List", "The Odin Project", "2022-11-15", true, true, projectList.allProjects[1]);
    let sampleTodo3 = new _classTodo_js__WEBPACK_IMPORTED_MODULE_0__["default"]("(Sample) Move on to next chapter", "Linting", "", false, false, projectList.allProjects[1]);
    let sampleTodo4 = new _classTodo_js__WEBPACK_IMPORTED_MODULE_0__["default"]("(Sample) Write weekly report", "", (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(today, 1), "yyyy-MM-dd"), true, false, projectList.allProjects[2]);
